...
export const Item = () => {
  return (
	  <Link to="/product/12333" className=" rounded-lg flex flex-col col-span-4 sm:col-span-3 row-span-1 items-center justify-center relative">
		  ...
		  <div className="flex flex-col w-full my-2">
			  <h1 className="text-zinc-700">Hoodie XXL</h1>
				<p className="text-sm text-zinc-500 md:text-xs">LCD Screen 56 Samsung...</p>
